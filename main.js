...
$(function() {
  ...
  function set_settings() {
    ...
    // In condition 2, user will receive 3 likes at the following timepoints (in ms). Default of normal inclusion: [10000, 35000,1320000]
settings.condition_2_likes = [10000, 35000,132000]; 
    
  // In condition 3, user will receive 6 likes at the following timepoints (in ms). Default: [10000, 15000,35000,80000,1320000,150000] #incl
...
settings.condition_1_adjusted_likes = [12000, 14000,15000,35000,80000,100000,110000,150000,20000]; // 9 #default
settings.condition_2_adjusted_likes = [12000, 14000,15000,35000,80000,100000,110000]; // 7 #I just added the two following timepoints
settings.condition_3_adjusted_likes = [12000, 14000,15000,35000,80000]; //5 #default
